...
$(document).ready(function(){
  firebase.auth().onAuthStateChanged(function(user){
    if(user){
      $("#log").replaceWith("<li><a href=\"html/accountSettings.html\">Account Settings</a></li><li><a>"+"Welcome " + firebase.auth().currentUser.displayName+"</a></li><li><a onclick=\"signOut()\">Sign Out</a></li>");
    }
  });
});
